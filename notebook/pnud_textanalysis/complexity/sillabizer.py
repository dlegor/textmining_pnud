...
This code is an adaptation of the code:
   https://github.com/dpalmasan/TRUNAJOD2.0/blob/master/src/TRUNAJOD/syllabizer.py
"""
...
class Syllabizer(object):
        ...
        for split_rule, where in RULES:
            ...
            if second:
                ...
                if first.word[-1] == 'c' and second.word[-1] == 'h':
                    continue
                return Syllabizer._split(first) + Syllabizer._split(second)
        return [chars]
    ...
    def number_of_syllables(word):
        ...
        return len(Syllabizer._split(charline))
